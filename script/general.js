    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'tbody',
          null,
          React.createElement(Header, { day: '2' }),
          day2_row
        )
      ),
      React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'tbody',
          null,
          React.createElement(Header, { day: '3' }),
          day3_row
        )
      )
    );
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        'th',
        { className: 'track a' },
        'A:IT Transformation Track'
      ),
      React.createElement(
        'th',
        { className: 'track b' },
        'B: Media & Entertainment Track'
      ),
      React.createElement(
        'th',
        { className: 'track c' },
